    ...
    <div class="row justify-content-md-center">
        <div class="col-3">
            <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                <a class="nav-link active font-weight-bolder mb-1 text-success" id="v-pills-home-tab" data-toggle="pill"
                   href="#v-pills-home" role="tab" aria-controls="v-pills-home" aria-selected="true">
                    <fmt:message key="repair.tab.creation"/>
                </a>
                <a class="nav-link font-weight-bolder mt-1 text-success" id="v-pills-profile-tab" data-toggle="pill"
